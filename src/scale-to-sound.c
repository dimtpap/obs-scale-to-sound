...
static obs_properties_t *scale_to_sound_properties(void *data)
{
	...
	obs_property_t *x_pos_alignment = obs_properties_add_list(p, STS_XPOSAL, "X Positional Alignment",
	...
	obs_property_t *y_pos_alignment = obs_properties_add_list(p, STS_YPOSAL, "Y Positional Alignment",
								  OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_INT);
